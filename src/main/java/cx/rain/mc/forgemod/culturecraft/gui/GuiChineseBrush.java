package cx.rain.mc.forgemod.culturecraft.gui;
...
public class GuiChineseBrush extends Screen {
    TextFieldWidget textFieldWidget;
    Button button;
    OptionSlider optionSlider;
    ResourceLocation OBSIDIAN_FIRST_GUI_TEXTURE = new ResourceLocation("culturecraft", "textures/gui/chinese_brush_gui.jpg");
    String content = "Hello";
    SliderPercentageOption sliderPercentageOption;
    Widget sliderBar;

    protected GuiChineseBrush(ITextComponent titleIn) {
        super(titleIn);
    }
