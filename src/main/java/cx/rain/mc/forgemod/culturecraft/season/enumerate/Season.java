...
import cx.rain.mc.forgemod.culturecraft.season.interfaces.ISeasonColor;
...
public enum Season {
    ...
    AUTUMN,
    WINTER;
  public enum SubSeason implements ISeasonColor
  {
    ...
    public enum TropicalSeason implements ISeasonColor
    {
