...
public class BlockItems {
    ...
    public static RegistryObject<Item> WHITE_RADISH =
            REGISTRY.register("radish_white", () -> new BlockNamedItem(Blocks.WHITE_RADISH_PLANT.get(),
                    new Item.Properties().group(Groups.FOODS).food(new Food.Builder().hunger(3).saturation(4).build())
                            .setNoRepair()));
    public static RegistryObject<Item> SUMMER_RADISH =
            REGISTRY.register("radish_summer", () -> new BlockNamedItem(Blocks.SUMMER_RADISH_PLANT.get(),
                    new Item.Properties().group(Groups.FOODS).food(new Food.Builder().hunger(2).saturation(3).build())
                            .setNoRepair()));
    public static RegistryObject<Item> GREEN_RADISH =
            REGISTRY.register("radish_green", () -> new BlockNamedItem(Blocks.GREEN_RADISH_PLANT.get(),
                    new Item.Properties().group(Groups.FOODS).food(new Food.Builder().hunger(2).saturation(5).build())
                            .setNoRepair()));
    ...
    public static RegistryObject<Item> LOG_PEACH_STRIPPED_SKIN =
            REGISTRY.register("log_peach_stripped_skin", () ->
                    new BlockItem(Blocks.LOG_PEACH_STRIPPED_SKIN.get(),
                            new Item.Properties().group(Groups.BLOCKS)));
    public static RegistryObject<Item> PLANK_PEACH =
            REGISTRY.register("plank_peach", () -> new BlockItem(Blocks.PLANK_PEACH.get(),
                    new Item.Properties().group(Groups.BLOCKS)));
    ...
    public static RegistryObject<Item> LOG_WALNUT_STRIPPED_SKIN =
            REGISTRY.register("log_walnut_stripped_skin", () ->
                    new BlockItem(Blocks.LOG_WALNUT_STRIPPED_SKIN.get(),
                            new Item.Properties().group(Groups.BLOCKS)));
    public static RegistryObject<Item> PLANK_WALNUT =
            REGISTRY.register("plank_walnut", () -> new BlockItem(Blocks.PLANK_WALNUT.get(),
                    new Item.Properties().group(Groups.BLOCKS)));
    ...
    public static RegistryObject<Item> WHITE_MARBLE =
            REGISTRY.register("white_marble", () -> new BlockItem(Blocks.WHITE_MARBLE.get(),
                    new Item.Properties().group(Groups.BLOCKS)));
    public static RegistryObject<Item> RED_MARBLE =
            REGISTRY.register("red_marble", () -> new BlockItem(Blocks.RED_MARBLE.get(),
                    new Item.Properties().group(Groups.BLOCKS)));
    public static RegistryObject<Item> BLACK_MARBLE =
            REGISTRY.register("black_marble", () -> new BlockItem(Blocks.BLACK_MARBLE.get(),
                    new Item.Properties().group(Groups.BLOCKS)));
