...
public class ProviderBlockLootTable extends ProviderBaseBlockLootTable {
    ...
    protected void registerTables() {
        ...
        getLootTables().put(ModBlocks.RICE_PLANT.get(), tableWithPools(droppingSeeds("rice_seeds", ModItems.RICE_SEED.get()), droppingCropsWithChanceByStage("rice", ModBlocks.RICE_PLANT.get(), 7, ModItems.RICE_SEED.get(), 2, 5)));
        getLootTables().put(ModBlocks.MILLET_PLANT.get(), tableWithPools(droppingSeeds("millet_seeds", ModItems.MILLET_SEED.get()), droppingCropsWithChanceByStage("millet", ModBlocks.MILLET_PLANT.get(), 7, ModItems.MILLET_SEED.get(), 2, 5)));
        getLootTables().put(ModBlocks.SORGHUM_PLANT.get(), tableWithPools(droppingSeeds("sorghum_seeds", ModItems.SORGHUM_SEED.get()), droppingCropsWithChanceByStage("sorghum", ModBlocks.SORGHUM_PLANT.get(), 7, ModItems.SORGHUM_SEED.get(), 2, 5)));
        getLootTables().put(ModBlocks.SOYBEAN_PLANT.get(), tableWithPools(droppingSeeds("soybean_seeds", ModItems.SOYBEAN.get()), droppingCropsWithChanceByStage("soybean", ModBlocks.SOYBEAN_PLANT.get(), 7, ModItems.SOYBEAN.get(), 2, 5)));
