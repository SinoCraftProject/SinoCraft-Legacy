package cx.rain.mc.forgemod.sinocraft.world.placer;
...
public class PlumLeavesPlacer extends FoliagePlacer {
    public PlumLeavesPlacer(FeatureSpread p_i241999_1_, FeatureSpread p_i241999_2_) {
