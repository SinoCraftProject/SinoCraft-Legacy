...
import cx.rain.mc.forgemod.sinocraft.item.food.ItemFood;
...
public class ModItems {
  ...
  public static RegistryObject<ItemFood> PEACH = REGISTRY.register("peach", () -> new ItemFood(EnumFoods.PEACH));

  public static RegistryObject<ItemFood> CHILI_PEPPER = REGISTRY.register("chili_pepper", () -> new ItemFood(EnumFoods.CHILI_PEPPER));

  public static RegistryObject<ItemFood> GREEN_PEPPER = REGISTRY.register("green_pepper", () -> new ItemFood(EnumFoods.GREEN_PEPPER));

  public static RegistryObject<ItemFood> EGGPLANT = REGISTRY.register("eggplant", () -> new ItemFood(EnumFoods.EGGPLANT));

  public static RegistryObject<ItemFood> CABBAGE = REGISTRY.register("cabbage", () -> new ItemFood(EnumFoods.CABBAGE));

  public static RegistryObject<ItemFood> ADUST_FOOD = REGISTRY.register("adust_food", () -> new ItemFood(EnumFoods.ADUST_FOOD));

  public static RegistryObject<ItemFood> COOKED_DUMPLING = REGISTRY.register("cooked_dumpling", () -> new ItemFood(EnumFoods.COOKED_DUMPLING));

  public static RegistryObject<ItemFood> BOWL_WITH_RICE = REGISTRY.register("bowl_with_rice", () -> new ItemFood(EnumFoods.BOWL_WITH_RICE));

  public static RegistryObject<ItemFood> BOWL_WITH_WATER = REGISTRY.register("bowl_with_water", () -> new ItemFood(EnumFoods.BOWL_WITH_WATER));

  public static RegistryObject<ItemFood> BOWL_WITH_PORRIDGE = REGISTRY.register("bowl_with_porridge", () -> new ItemFood(EnumFoods.BOWL_WITH_PORRIDGE));
  ...
  public static RegistryObject<ItemClothHelmet> CLOTH_HELMET = REGISTRY.register("cloth_helmet", ItemClothHelmet::new);
