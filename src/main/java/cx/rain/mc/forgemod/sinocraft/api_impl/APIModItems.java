...
public enum APIModItems implements cx.rain.mc.forgemod.sinocraft.api.item.IModItems {

    INSTANCE;

    @Override
    public RegistryObject<? extends Item> getChiliPepperSeed() {
        return ModItems.CHILI_PEPPER_SEED;
    }

    @Override
    public RegistryObject<? extends Item> getGreenPepperSeed() {
        return ModItems.GREEN_PEPPER_SEED;
    }

    @Override
    public RegistryObject<? extends Item> getEggplantSeed() {
        return ModItems.EGGPLANT_SEED;
    }

    @Override
    public RegistryObject<? extends Item> getCabbageSeed() {
        return ModItems.CABBAGE_SEED;
    }

    @Override
    public RegistryObject<? extends Item> getRiceSeed() {
        return ModItems.RICE_SEED;
    }

    @Override
    public RegistryObject<? extends Item> getMilletSeed() {
        return ModItems.MILLET_SEED;
    }

    @Override
    public RegistryObject<? extends Item> getSorghumSeed() {
        return ModItems.SORGHUM_SEED;
    }

    @Override
    public RegistryObject<? extends Item> getSoybean() {
    ...
    @Override
    public RegistryObject<? extends Item> getBucketWoodPulp() {
    ...
    @Override
    public RegistryObject<? extends Item> getKnifeIron() {
        return ModItems.KNIFE_IRON;
    }

    @Override
    public RegistryObject<? extends Item> getKnifeGold() {
        return ModItems.KNIFE_GOLD;
    }

    @Override
    public RegistryObject<? extends Item> getKnifeDiamond() {
    ...
    @Override
    public RegistryObject<? extends Item> getBuffaloSpawnEgg() {
