...
public class Fluids {
    ...
    public static ForgeFlowingFluid.Properties WOOD_PULP_PROPERTIES = new ForgeFlowingFluid.Properties(WOOD_PULP, WOOD_PULP_FLOWING, FluidAttributes.builder(new ResourceLocation("minecraft","block/water_still"), new ResourceLocation("minecraft","block/water_flow")).color(0xFF311cbb).density(10)).bucket(Items.BUCKET_WOOD_PULP).block(()-> (FlowingFluidBlock) Blocks.WOOD_PULP_BLOCK.get()).slopeFindDistance(3).explosionResistance(100F);
}