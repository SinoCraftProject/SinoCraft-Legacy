...
public interface IModItems {
    RegistryObject<? extends Item> getChiliPepperSeed();

    RegistryObject<? extends Item> getGreenPepperSeed();

    RegistryObject<? extends Item> getEggplantSeed();

    RegistryObject<? extends Item> getCabbageSeed();

    RegistryObject<? extends Item> getRiceSeed();

    RegistryObject<? extends Item> getMilletSeed();

    RegistryObject<? extends Item> getSorghumSeed();

    RegistryObject<? extends Item> getSoybean();
    ...
    RegistryObject<? extends Item> getBucketWoodPulp();
    ...
    RegistryObject<? extends Item> getKnifeIron();

    RegistryObject<? extends Item> getKnifeGold();

    RegistryObject<? extends Item> getKnifeDiamond();
