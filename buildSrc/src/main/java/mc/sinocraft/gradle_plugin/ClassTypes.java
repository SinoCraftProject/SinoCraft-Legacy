...
public class ClassTypes {
    ...
    public static final ClassName BlockMarble = ClassName.get("cx.rain.mc.forgemod.sinocraft.block.marble", "BlockMarble");
    public static final ClassName MarbleType = ClassName.get("cx.rain.mc.forgemod.sinocraft.block.marble", "MarbleType");
    public static final ClassName BlockPlant = ClassName.get("cx.rain.mc.forgemod.sinocraft.block.plant", "BlockPlant");
    public static final ClassName PlantType = ClassName.get("cx.rain.mc.forgemod.sinocraft.block.plant", "PlantType");
    public static final ClassName BlockLeaves = ClassName.get("cx.rain.mc.forgemod.sinocraft.block.tree", "BlockLeaves");
    public static final ClassName BlockLog = ClassName.get("cx.rain.mc.forgemod.sinocraft.block.tree", "BlockLog");
    public static final ClassName BlockLogStrippable = ClassName.get("cx.rain.mc.forgemod.sinocraft.block.tree", "BlockLogStrippable");
    public static final ClassName BlockPlank = ClassName.get("cx.rain.mc.forgemod.sinocraft.block.tree", "BlockPlank");
    public static final ClassName BlockSapling = ClassName.get("cx.rain.mc.forgemod.sinocraft.block.tree", "BlockSapling");
    public static final ClassName BlockLeavesGrowable = ClassName.get("cx.rain.mc.forgemod.sinocraft.block.tree", "BlockLeavesGrowable");
    public static final ClassName TreeType = ClassName.get("cx.rain.mc.forgemod.sinocraft.block.tree", "TreeType");
    ...
    public static final ClassName ItemFood = ClassName.get("cx.rain.mc.forgemod.sinocraft.item.food", "ItemFood");
    // net.minecraft.*
